...
class C2():
    ...
    def __init__(self, host='0.0.0.0', port=1337, db=':memory:'):
        ...
        self.commands = {
            ...
            'test':{
                'method': 'you must first connect to a session to use this command',
                'description': 'test test test test l', 
                'usage':'test'},
            'http_sender':{
                'method': 'you must first connect to a session to use this command',
                'description': 'send http requests defined in json file', 
                'usage':'http_sender [file]'},
            'ddos':{
                'method': 'you must first connect to a session to use this command',
                'description': 'ddos', 
                'usage':'ddos command [link]'}
